      ...
      setEnhancedPBIs([
        {
          ...
          agentReviews: [
            ...
            },
            {
              ...
              role: 'Frontend',
              feedback:
                'Not applicable. This is purely a backend API ticket, so no React or CSS changes are needed.',
            },
            {
              agentName: 'Node',
              role: 'Backend',
              feedback:
                'I will create the `/api/register` route using Next.js route handlers and the `bcrypt` standard library.',
            },
          ],
        },
        {
          ...
          agentReviews: [
            {
              ...
              role: 'Security',
              feedback:
                'Ensure we are not logging passwords in the browser console during error states.',
            },
            {
              agentName: 'ArchBot',
              role: 'Architect',
              feedback: 'We should use React Hook Form for state management.',
            },
            {
              agentName: 'QABot',
              role: 'QA',
              feedback: 'Write Cypress tests for the red validation error state.',
            },
            {
              agentName: 'LawBot',
              role: 'Compliance',
              feedback: 'Include a link to the privacy policy below the submit button.',
            },
            {
              agentName: 'Pixel',
              role: 'Frontend',
              feedback:
                'I will build this using Tailwind classes and Lucide icons for the error alert.',
            },
            {
              agentName: 'Node',
              role: 'Backend',
              feedback: 'Not applicable. Let the frontend handle the visual state.',
            },
          ],
        },
      ]);
    ...
    return (
      <div className="swarm-setup">
        ...
        <p className="tab-desc">
          Provide a local repository to give the swarm architectural and codebase context before
          evaluating the breakdown and writing Gherkin PBIs.
        </p>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '8px', marginTop: '12px' }}>
            <button
              ...
              onClick={() =>
                setLocalPath('/Users/patrickditzler/Desktop/Repos/team-prd-review-tool')
              }
            >
      ...
      >
        <div
          ...
          style={{
            ...
            borderWidth: '3px',
            margin: '0 auto 16px',
            borderColor: 'var(--color-primary) transparent var(--color-primary) transparent',
          }}
        />
        <h3 style={{ fontSize: '18px', fontWeight: 600, marginBottom: '8px' }}>
          The Swarm is Analyzing...
        </h3>
        <p
          style={{
        ...
        >
          Reading codebase context, generating detailed PBIs with Gherkin scenarios, and consulting
          the Security, Architect, QA, Legal, Frontend, and Backend agents.
        </p>
        <div
          style={{
            display: 'flex',
        ...
        >
          <Shield className="pulse-anim" />{' '}
          <Ruler className="pulse-anim" style={{ animationDelay: '0.2s' }} />{' '}
          <FlaskConical className="pulse-anim" style={{ animationDelay: '0.4s' }} />{' '}
          <Gavel className="pulse-anim" style={{ animationDelay: '0.6s' }} />{' '}
          <LayoutTemplate className="pulse-anim" style={{ animationDelay: '0.8s' }} />{' '}
          <Database className="pulse-anim" style={{ animationDelay: '1.0s' }} />
        </div>
      </div>
    );
  }
      ...
      {enhancedPBIs.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          {enhancedPBIs.map((pbi, i) => (
            <div
              key={i}
              className="review-card pbi-card"
              style={{ border: '1px solid var(--color-primary-muted)', overflow: 'hidden' }}
            >
              <div
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  {editingPbiIndex === i ? (
                    <button
                      ...
                      style={{ padding: '4px 12px', fontSize: '12px', width: 'auto', margin: 0 }}
                      onClick={() => setEditingPbiIndex(null)}
                    >
                      Save Edits
                    </button>
                  ) : (
                ...
                >
                  ...
                  <div>
                    ...
                    {editingPbiIndex === i ? (
                      ...
                      <div
                        className="markdown-body gherkin-block"
                        style={{
                          background: '#1e1e1e',
                          color: '#d4d4d4',
                          padding: '16px',
                      ...
                      >
                        ...
                        >
                          ...
                          {agent.role === 'Compliance' && (
                            <Gavel size={16} color="var(--color-success)" />
                          )}
                          {agent.role === 'Frontend' && (
                            <LayoutTemplate size={16} color="#db2777" />
                          )}
          ...
          >
            <button
              className="btn-primary"
              style={{ width: 'auto', background: '#0078D4' }}
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: '14px', color: 'var(--color-text-muted)', marginBottom: '24px' }}>
              Export the PRD as a Feature and these PBIs as linked child work items.
            </p>
              ...
              <>
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      value={azureConfig.org}
                      onChange={(e) => setAzureConfig({ ...azureConfig, org: e.target.value })}
                    />
                  </div>
                  <div>
                    <label
                ...
                <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
                  ...
                  <button
                    className="btn-secondary"
                    style={{ width: 'auto' }}
                    onClick={() => handleExportAzure(true)}
                    disabled={isExporting}
                  >
